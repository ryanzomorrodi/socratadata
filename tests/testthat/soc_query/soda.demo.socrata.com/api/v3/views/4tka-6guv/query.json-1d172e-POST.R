structure(list(method = "POST", url = "https://soda.demo.socrata.com/api/v3/views/4tka-6guv/query.json", 
    status_code = 200L, headers = structure(list(Server = "nginx", 
        Date = "Mon, 18 Aug 2025 06:12:47 GMT", `Content-Type` = "application/json; charset=utf-8", 
        ...
        `X-Socrata-RequestId` = "eee06907f2f51f718bccb414630b01dd", 
    ...
    pretransfer = 7.4e-05, starttransfer = 0.29104, total = 0.291139
