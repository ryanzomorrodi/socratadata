structure(list(method = "GET", url = "https://soda.demo.socrata.com/resource/4tka-6guv.json?%24select=source&%24limit=10", 
    status_code = 200L, headers = structure(list(Server = "nginx", 
        Date = "Mon, 18 Aug 2025 05:09:09 GMT", `Content-Type` = "application/json;charset=utf-8", 
        ...
        `X-Socrata-RequestId` = "7b448746d425d56a554739d40ad4b35f"), class = "httr2_headers"), 
    body = charToRaw("[{\"source\":\"hv\"}\n,{\"source\":\"ak\"}\n,{\"source\":\"ak\"}\n,{\"source\":\"ak\"}\n,{\"source\":\"uw\"}\n,{\"source\":\"us\"}\n,{\"source\":\"ak\"}\n,{\"source\":\"us\"}\n,{\"source\":\"ak\"}\n,{\"source\":\"us\"}]\n"), 
    timing = c(redirect = 0, namelookup = 1.3e-05, connect = 0, 
    pretransfer = 6.6e-05, starttransfer = 0.126598, total = 0.126683
