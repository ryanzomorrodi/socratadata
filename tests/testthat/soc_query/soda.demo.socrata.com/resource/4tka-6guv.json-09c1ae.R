structure(list(method = "GET", url = "https://soda.demo.socrata.com/resource/4tka-6guv.json?%24select=magnitude%2C%20count%28%2A%29%20as%20count&%24group=magnitude&%24having=count%20%3E%20400&%24order=count&%24offset=10000&%24limit=10000", 
    status_code = 200L, headers = structure(list(Server = "nginx", 
        ...
        `X-Socrata-RequestId` = "407d3a68502daba4fbe6440dec14c2de"), class = "httr2_headers"), 
    body = charToRaw("[]\n"), timing = c(redirect = 0, namelookup = 1.2e-05, 
    connect = 0, pretransfer = 7.3e-05, starttransfer = 0.096958, 
    total = 0.097071), cache = new.env(parent = emptyenv())), class = "httr2_response")
