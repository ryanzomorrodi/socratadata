structure(list(method = "POST", url = "https://data.cityofchicago.org/api/v3/views/zidz-sdfj/query.json", 
    status_code = 200L, headers = structure(list(Server = "nginx", 
        Date = "Mon, 18 Aug 2025 06:13:57 GMT", `Content-Type` = "application/json; charset=utf-8", 
        ...
        `X-Socrata-RequestId` = "1064df9a0c3c3e735967966eece8eade", 
    ...
    pretransfer = 8.3e-05, starttransfer = 0.291219, total = 0.291325
