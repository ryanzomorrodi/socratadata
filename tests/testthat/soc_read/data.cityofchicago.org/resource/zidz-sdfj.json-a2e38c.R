structure(list(method = "GET", url = "https://data.cityofchicago.org/resource/zidz-sdfj.json?%24select=%2A&%24limit=10", 
    status_code = 200L, headers = structure(list(Server = "nginx", 
        Date = "Mon, 18 Aug 2025 06:13:56 GMT", `Content-Type` = "application/json;charset=utf-8", 
        ...
        `X-Socrata-RequestId` = "22cb69323b124977ab001c1ab07bf444"), class = "httr2_headers"), 
    ...
    pretransfer = 9.7e-05, starttransfer = 0.128804, total = 0.12891
