structure(list(method = "POST", url = "https://soda.demo.socrata.com/api/v3/views/2asz-g9qq/query.json", 
    status_code = 200L, headers = structure(list(Server = "nginx", 
        ...
        `X-Socrata-RequestId` = "c8ed363d83e258fed9589a14b9e8ce97", 
        `Content-Encoding` = "gzip"), class = "httr2_headers"), 
    body = charToRaw("[\n]\n"), timing = c(redirect = 0, namelookup = 1.8e-05, 
    connect = 0, pretransfer = 7.8e-05, starttransfer = 0.194687, 
    total = 0.194767), cache = new.env(parent = emptyenv())), class = "httr2_response")
