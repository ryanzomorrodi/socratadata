structure(list(method = "POST", url = "https://soda.demo.socrata.com/api/v3/views/7caz-dk9s/query.json", 
    status_code = 200L, headers = structure(list(Server = "nginx", 
        Date = "Mon, 18 Aug 2025 06:14:04 GMT", `Content-Type` = "application/json; charset=utf-8", 
        ...
        `X-Socrata-RequestId` = "b6463beda8d0d47da9fe5faf12739359", 
    ...
    pretransfer = 9.9e-05, starttransfer = 0.288459, total = 0.288514
